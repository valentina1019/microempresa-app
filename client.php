  ...
  <body>
    <div class="container panel">
      ...
      <div class="page-header">
        <div>
          <p class="eyebrow">Modulo de clientes</p>
          <h1>Acceso a Clientes</h1>
          <p class="page-subtitle">El CRUD de clientes ahora se administra desde la gestion centralizada.</p>
        </div>
      ...
      <div class="dashboard-card clients">
        ...
        <div>
          ...
          <p>Usa este modulo para crear, editar, buscar y eliminar clientes.</p>
        </div>
      </div>

      <div class="hero-actions">
        <a class="button-link" data-loading-link href="clientes-list.php"><span class="button-icon"><?php echo ui_icon('clients'); ?></span>Ir a gestion de clientes</a>
